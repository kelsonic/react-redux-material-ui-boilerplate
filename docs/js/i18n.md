...
You will also notice a more complex use of `FormattedMessage` for the author message where alternate or variable values (i.e. `author: <A href="http://kelsonic.io">Kelsonic</A>,`) are being injected, in this case it's a react component.
      ...
      <section>
        <p>
          <FormattedMessage
            ...
            values={{
              author: <A href="http://kelsonic.io">Kelsonic</A>,
            }}
          />
        </p>
      </section>
